...
export const SocialLoginSection = memo<SocialLoginSectionProps>(({ 
  onEmailLogin, 
  disabled = false 
}) => {
  return (
    <div>
      ...
      <SocialLoginButton disabled={disabled}>
        <div style={{ display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center' }}>
          <svg 
            ...
            style={{ width: '16px', height: '16px', display: 'block', fill: 'inherit', flexShrink: 0, position: 'absolute', insetInlineStart: '10px' }}
          >
            <g clipPath="url(#clip0_2234_44729)">
              <path fill="#4285F4" d="M18.64 10.205q-.002-.958-.164-1.841H10v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.875 2.684-6.615"></path>
              <path fill="#34A853" d="M10 19c2.43 0 4.467-.806 5.956-2.18l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H1.957v2.332A9 9 0 0 0 10 19"></path>
              <path fill="#FBBC04" d="M4.964 11.71A5.4 5.4 0 0 1 4.682 10c0-.593.102-1.17.282-1.71V5.958H1.957A9 9 0 0 0 1 10c0 1.452.348 2.827.957 4.042z"></path>
              <path fill="#E94235" d="M10 4.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C14.463 1.891 12.426.999 10 .999a9 9 0 0 0-8.043 4.958L4.964 8.29C5.672 6.163 7.656 4.58 10 4.58"></path>
            </g>
            <defs>
          ...
          <div style={{ fontSize: '17px', lineHeight: '22px', fontWeight: 500 }}>Google 登录</div>
        </div>
      </SocialLoginButton>
      ...
      <SocialLoginButton disabled={disabled}>
        <div style={{ display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center' }}>
          ...
          <div style={{ fontSize: '17px', lineHeight: '22px', fontWeight: 500 }}>Apple 登录</div>
        </div>
      </SocialLoginButton>
      ...
      <SocialLoginButton disabled={disabled}>
        <div style={{ display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center' }}>
          ...
          <div style={{ fontSize: '17px', lineHeight: '22px', fontWeight: 500 }}>单点登录（SSO）</div>
        </div>
      </SocialLoginButton>
      ...
      <SocialLoginButton onClick={onEmailLogin} disabled={disabled}>
        <div style={{ display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center' }}>
          <svg 
            ...
            style={{ width: '16px', height: '16px', display: 'block', fill: 'inherit', flexShrink: 0, position: 'absolute', insetInlineStart: '10px' }}
          >
            <path d="M2.375 6.25c0-1.174.951-2.125 2.125-2.125h11c1.174 0 2.125.951 2.125 2.125v7.5a2.125 2.125 0 0 1-2.125 2.125h-11a2.125 2.125 0 0 1-2.125-2.125zm1.25 7.49L7.366 10 3.625 6.259zm.884.885H15.49l-3.74-3.741-1.309 1.308a.625.625 0 0 1-.884 0L8.25 10.884zM12.634 10l3.741 3.741V6.26zM4.509 5.375 10 10.866l5.491-5.491z"></path>
          </svg>
          <div style={{ fontSize: '17px', lineHeight: '22px', fontWeight: 500 }}>电子邮件登录</div>
        </div>
      </SocialLoginButton>
    </div>
  );
